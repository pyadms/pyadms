...
#define LOAD_RESIDUAL_RESIST(name) dst[inst->node_off[name]] += inst->residual_resist[name];
...
#define RESIST_RESIDUAL_OFF(NODE) (offsetof(DiodeInstace, residual_resist) + sizeof(uint32_t) * NODE)
