...
// implementation of the @setupmodel@setup_model@ function as defined in the
// OSDI spec
...
// TODO implementation of the @loadnoise@load_noise@ function as defined in the
// OSDI spec
...
// implementation of the @loadspicerhsdc@load_spice_rhs_dc@ function as defined
// in the OSDI spec
...
// implementation of the @loadspicerhstran@load_spice_rhs_tran@ function as
// defined in the OSDI spec
...
// this is the main structure used by simulators, it gives @access@access@ to
// all information in a model
